...
<table id="historico" style="margin:auto;border-collapse:collapse;min-width:380px;">
  <thead>
    <tr>
      <th style="border:1px solid #444;padding:8px 14px;">Operação</th>
      <th style="border:1px solid #444;padding:8px 14px;">Resultado (4 bits)</th>
      <th style="border:1px solid #444;padding:8px 14px;">Overflow</th>
      <th style="border:1px solid #444;padding:8px 14px;">Tempo (ms)</th>
    </tr>
  </thead>
...
function toggleB(){
  ...
  document.getElementById('campo-b').style.display = (op === 'fat') ? 'none' : 'block';
}
...
function calc(){
  ...
  let op = document.getElementById('op').value;
  let b = (op === 'fat') ? 0 : parseInt(document.getElementById('b').value);
  ...
  .then(d => {
    ...
    tr.innerHTML =
      '<td style="border:1px solid #444;padding:6px 14px;">' + conta + '</td>' +
      '<td style="border:1px solid #444;padding:6px 14px;">' + bin4(d.bits) + ' (' + d.resultado + ')</td>' +
      '<td style="border:1px solid #444;padding:6px 14px;">' + (d.overflow ? 'SIM' : 'NAO') + '</td>' +
      '<td style="border:1px solid #444;padding:6px 14px;">' + tempo + ' ms</td>';
